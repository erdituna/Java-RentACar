...
public class Messages {
    ...
    public static final String BRANDADD= "brand_add";//1--
    public static final String BRANDUPDATE = "brand_update";//2--
    public static final String BRANDDELETE = "brand_delete";//3 --
    public static final String BRANDLIST = "brand_list";//4 --
    ...
    public static final String CITYADD = "city_add";//22 --
    public static final String CITYUPDATE = "city_update";//23 // --.
    ...
    public static final String CITYFOUND = "city_found"; //27--
